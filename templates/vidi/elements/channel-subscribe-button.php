...
<div class="watch-later-element">
    <?php
        ...
        $haru_watch_later_page = haru_vidi_get_setting( 'haru_watch_later_page', 'vidi-general-settings', '#' );
        $haru_watch_later_page_url = ( $haru_watch_later_page != '' && is_numeric( $haru_watch_later_page ) ) ? get_permalink( $haru_watch_later_page ) : '#'; 
    ?>
    <a href="<?php echo esc_url( $haru_watch_later_page_url ); ?>" class="watch-later-page-link">
