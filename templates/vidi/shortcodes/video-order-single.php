...
$shortcode_id = 'video-order-single-shortcode' . rand();
...
?>
<?php if ( have_posts() ) : ?>
    <div class="video-order-single-shortcode <?php echo esc_attr( $layout . ' ' . $extra_class); ?>" id="<?php echo esc_attr( $shortcode_id ); ?>" data-atts="<?php echo htmlentities( json_encode($atts) ); ?>">
                ...
                <li class="tab-item <?php echo esc_attr( $tab ); ?>">
                    <h6 class="tab-item-heading">
                        <a class="filter-item <?php echo esc_attr( ($key == 0) ? 'active' : '' ); ?>"
                            href="javascript:;"
                            data-video_order="<?php echo esc_attr( $tab ); ?>"><?php echo esc_html( $$tab_title ); ?></a>
                    </h6>
                </li>
            <?php
                    endforeach;
        ...
        <div class="video-ajax-content <?php echo esc_attr( $layout ); ?>">
            ...
            <div class="video-order-single-content">
