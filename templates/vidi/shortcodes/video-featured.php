...
$shortcode_id = 'video-featured-shortcode' . rand();
...
if ( in_array($layout, array('default', 'style-2') ) ) {
    $posts_per_page = 5;
}

$atts = compact('layout', 'categories', 'posts_per_page', 'filter', 'filter_all', 'orderby', 'order', 'view_more');
...
?>
<?php if ( have_posts() ) : ?>
    <div class="video-featured-shortcode <?php echo esc_attr( $layout . ' ' . $extra_class); ?>" data-atts="<?php echo htmlentities( json_encode($atts) ); ?>" id="<?php echo esc_attr( $shortcode_id ) ?>">
        <?php
        ...
        <div class="video-featured-top">
            <?php if ( $title != '' ) : ?>
                <h6 class="video-featured-title haru-shortcode-title"><?php echo esc_attr( $title ); ?></h6>
            <?php endif; ?>
        ...
        <div class="video-ajax-content">
            ...
            <div class="video-featured-content">
                ...
                <div class="video-list grid-columns grid-columns__featured animated fadeIn haru-clear">
                <?php endif; ?>
                <?php 
